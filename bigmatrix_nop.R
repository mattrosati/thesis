...
fibroblast <- read.csv(file = data_list[9], header = T)
hepatocyte <- read.csv(file = data_list[10], header = T)
# intestine <- read.csv(file = data_list[8], header = T)
keratinocyte <- read.csv(file = data_list[14], header = T)
microglial <- read.csv(file = data_list[15], header = T)
thyroid <- read.csv(file = data_list[20], header = T)
...
#save
write.csv(globals.nodup, file = "~/Desktop/MacMicking Lab/IFN_microarray/suppressedmatrix_nop.csv")
write.csv(globala.nodup, file = "~/Desktop/MacMicking Lab/IFN_microarray/activatedmatrix_nop.csv")
